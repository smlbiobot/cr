...
.method private a(II)V
    ...
    invoke-static {v0, v1, v2}, Lcom/google/android/gms/common/internal/u;->a(Landroid/content/Context;II)Landroid/view/View;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/gms/common/SignInButton;->c:Landroid/view/View;
    :try_end_0
    .catch Lcom/google/android/gms/dynamic/b; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v4, v0}, Lcom/google/android/gms/common/internal/v;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v0}, Lcom/google/android/gms/common/internal/v;->setTypeface(Landroid/graphics/Typeface;)V

    const/high16 v0, 0x41600000    # 14.0f

    invoke-virtual {v4, v0}, Lcom/google/android/gms/common/internal/v;->setTextSize(F)V
    ...
    invoke-virtual {v4, v1}, Lcom/google/android/gms/common/internal/v;->setMinHeight(I)V
    ...
    invoke-virtual {v4, v0}, Lcom/google/android/gms/common/internal/v;->setMinWidth(I)V
    ...
    invoke-static {v3, v0, v1, v6}, Lcom/google/android/gms/common/internal/v;->a(IIII)I

    move-result v1

    sget v0, Lcom/google/android/gms/R$drawable;->common_google_signin_btn_text_dark:I

    sget v6, Lcom/google/android/gms/R$drawable;->common_google_signin_btn_text_light:I

    sget v7, Lcom/google/android/gms/R$drawable;->common_google_signin_btn_text_light:I

    invoke-static {v3, v0, v6, v7}, Lcom/google/android/gms/common/internal/v;->a(IIII)I
    ...
    invoke-virtual {v4, v0}, Lcom/google/android/gms/common/internal/v;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v4, v0}, Lcom/google/android/gms/common/internal/v;->setTextColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v4, v0}, Lcom/google/android/gms/common/internal/v;->setText(Ljava/lang/CharSequence;)V

    :goto_1
    invoke-virtual {v4, v9}, Lcom/google/android/gms/common/internal/v;->setTransformationMethod(Landroid/text/method/TransformationMethod;)V

    invoke-virtual {v4}, Lcom/google/android/gms/common/internal/v;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, Lcom/google/android/gms/common/util/f;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v4, v0}, Lcom/google/android/gms/common/internal/v;->setGravity(I)V
    ...
    :pswitch_4
    invoke-virtual {v4, v9}, Lcom/google/android/gms/common/internal/v;->setText(Ljava/lang/CharSequence;)V
