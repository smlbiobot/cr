.class public Lcom/helpshift/support/j/i;
.super Ljava/lang/Object;


# instance fields
.field private a:Lcom/helpshift/support/j/h;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Lcom/helpshift/support/j/h;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/helpshift/support/j/i;->a:Lcom/helpshift/support/j/h;

    return-void
.end method

.method private static c(Lcom/helpshift/account/dao/ProfileDTO;)Landroid/content/ContentValues;
    .locals 3
    ...
    iget-object v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->c:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "profile_id"

    iget-object v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->b:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "name"

    iget-object v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->d:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "email"

    iget-object v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->e:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "salt"

    iget-object v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->f:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "uid"

    iget-object v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->g:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "did"

    iget-object v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->h:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "push_token_sync"

    iget-boolean v2, p0, Lcom/helpshift/account/dao/ProfileDTO;->i:Z
...
.method public final declared-synchronized a(Ljava/lang/String;)Lcom/helpshift/account/dao/ProfileDTO;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/helpshift/support/j/i;->a:Lcom/helpshift/support/j/h;

    invoke-virtual {v0}, Lcom/helpshift/support/j/h;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public final declared-synchronized a(Lcom/helpshift/account/dao/ProfileDTO;)V
    ...
    invoke-virtual {v0}, Lcom/helpshift/support/j/h;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v0

    invoke-static {p1}, Lcom/helpshift/support/j/i;->c(Lcom/helpshift/account/dao/ProfileDTO;)Landroid/content/ContentValues;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v0}, Lcom/helpshift/util/e;->a(Ljava/lang/String;)V
    :try_end_1
...
.method public final declared-synchronized b(Lcom/helpshift/account/dao/ProfileDTO;)V
    .locals 5
    ...
    iget-object v2, p0, Lcom/helpshift/support/j/i;->a:Lcom/helpshift/support/j/h;

    invoke-virtual {v2}, Lcom/helpshift/support/j/h;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    const-string/jumbo v2, "Error in insertOrUpdateProfile"
