...
.method public static a(Landroid/content/Context;Landroid/app/Service;)V
    ...
    invoke-static {p0}, Lcom/supercell/titan/dk;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {v1, p0, p1, v0}, Lcom/supercell/titan/f;-><init>(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/Class;)V

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    invoke-virtual {v1, v0}, Lcom/supercell/titan/f;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    :try_end_0
...
.method public static a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/Class;)V
    ...
    invoke-static/range {v0 .. v11}, Lcom/supercell/titan/dk;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Class;Landroid/app/Service;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Class;Landroid/app/Service;)V
    ...
    invoke-static {p0, v6, v10, v4}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {v5, p0, v0}, Landroid/support/v4/app/NotificationCompat$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :try_start_0
    const-string/jumbo v4, "ic_notification"

    const-string/jumbo v5, "drawable"

    invoke-virtual {v8, v4, v5, v7}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    :try_start_1
    invoke-static/range {p5 .. p5}, Lcom/supercell/titan/dk;->a(Ljava/lang/String;)[B
    ...
    const-string/jumbo v4, ".assetprovider"
    ...
    invoke-virtual {v9, v3}, Landroid/support/v4/app/NotificationCompat$Builder;->setSound(Landroid/net/Uri;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v9, v0}, Landroid/support/v4/app/NotificationCompat$Builder;->setColor(I)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v0, v6, v3}, Landroid/app/Service;->startForeground(ILandroid/app/Notification;)V
    ...
    const-string/jumbo v11, "Could not download image from "
...
.method private static a(Ljava/lang/String;)[B
    ...
    invoke-static {v1}, Lcom/supercell/titan/dk;->a(Ljava/io/InputStream;)[B
    :try_end_0
